...
describe('Test cases for [xmssFast]', () => {
  ...
  describe('genLeafWOTS', () => {
    it('should generate leafWOTS, with SHA2_256 hashing', () => {
      const leaf = getUInt8ArrayFromHex('4704050c2d07620517381704050c2d07220517381704050c2d07220517380309');
      const skSeed = getUInt8ArrayFromHex('0305010501020503020602070305010205030206');
      const xmssParams = newXMSSParams(32, 2, 16, 2);
      ...
      const expectedLeaf = getUInt8ArrayFromHex('782c0df98779a224ce660187ccb3a5bac7f60f2c02ddd66c7e57f17ce1b434d6');
      ...
      const expectedLTreeAddr = getUInt32ArrayFromHex(
        '0000002c0000000b000000060000000700000003000000070000000000000002'
      );
      const expectedOtsAddr = getUInt32ArrayFromHex('0000002c0000000b000000060000000700000016000000420000000e00000001');
  ...
  describe('bdsRound', () => {
    it('should run bdsRound, with SHA2_256 hashing', () => {
      ...
      expectedBdsState.auth = getUInt8ArrayFromHex(
        ''
      );
  ...
  describe('treeHashUpdate', () => {
    it('should update tree hash, with SHA2_256 hashing', () => {
      ...
      expectedTreeHash.node = getUInt8ArrayFromHex('af02bddf839dc5aa5a152c304981b6bfbc6e3f7fb5f92de423bd60c518a149e8');
